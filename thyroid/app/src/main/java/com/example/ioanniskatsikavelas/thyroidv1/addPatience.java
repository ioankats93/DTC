...
public class addPatience extends AppCompatActivity implements View.OnClickListener {
    ...
    private void registerUser() {
        ...
        register(name, surname, username, password, email, ami, amth, telephone, house, sex, birth, diagnosis, surgery,
    ...
    private void register(String name, String surname, String username, String password, String email, String ami, String amth, String telephone,
        ...
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(addPatience.this, "Please Wait", null, true, true);
            }
